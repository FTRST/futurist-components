...
const WindowInset = React.forwardRef(({ value, children, variant = 'default', style, styleSettings, className }, ref) => (
    <StyledWindowInset
        ref={ref}
        className={`ftrst window-inset ${variant !== 'default' ? `${variant}-` : ''}${className || ''}`}
